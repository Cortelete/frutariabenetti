...
const LinkButton: React.FC<LinkButtonProps> = ({ name, url, icon, type, onClick }) => {
    const commonClasses = "relative w-full flex items-center p-2 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-green-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-green-500 bg-white/50 border border-green-400/40 hover:border-green-500 overflow-hidden text-green-900";
